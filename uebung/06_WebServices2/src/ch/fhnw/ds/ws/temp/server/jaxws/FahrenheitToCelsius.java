...
@XmlRootElement(name = "fahrenheitToCelsius", namespace = "http://server.temp.ws.ds.fhnw.ch/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "fahrenheitToCelsius", namespace = "http://server.temp.ws.ds.fhnw.ch/")
