...
@XmlRootElement(name = "celciusToFahrenheit", namespace = "http://server.temp.ws.ds.fhnw.ch/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "celciusToFahrenheit", namespace = "http://server.temp.ws.ds.fhnw.ch/")
