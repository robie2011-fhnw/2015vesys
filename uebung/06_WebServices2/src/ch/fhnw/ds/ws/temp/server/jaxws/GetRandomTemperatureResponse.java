...
@XmlRootElement(name = "getRandomTemperatureResponse", namespace = "http://server.temp.ws.ds.fhnw.ch/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getRandomTemperatureResponse", namespace = "http://server.temp.ws.ds.fhnw.ch/", propOrder = {
    "resultC",
    "resultF"
})
