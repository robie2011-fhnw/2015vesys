...
@XmlRootElement(name = "fahrenheitToCelsiusResponse", namespace = "http://server.temp.ws.ds.fhnw.ch/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "fahrenheitToCelsiusResponse", namespace = "http://server.temp.ws.ds.fhnw.ch/")
