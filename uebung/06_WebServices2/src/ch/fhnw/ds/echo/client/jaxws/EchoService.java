 ...
 * 
 */
@WebServiceClient(name = "EchoService", targetNamespace = "http://server.echo.ds.fhnw.ch/", wsdlLocation = "http://localhost:9898/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECHOSERVICE_QNAME = new QName("http://server.echo.ds.fhnw.ch/", "EchoService");
    ...
    public Echo getEchoPort() {
        return super.getPort(new QName("http://server.echo.ds.fhnw.ch/", "EchoPort"), Echo.class);
    }
    ...
    public Echo getEchoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.echo.ds.fhnw.ch/", "EchoPort"), Echo.class, features);
    }
